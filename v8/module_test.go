...
func TestModuleFunctions(t *tes.T) {
	...
	var group com.Synchronized = new(syn.WaitGroup)
	defer group.Wait()
...
func TestContinuumConstructors(t *tes.T) {
	var numbers = com.Continuum[Number](
		com.Exclusive,
		Number(-1.23),
		Number(4.56),
		com.Exclusive,
